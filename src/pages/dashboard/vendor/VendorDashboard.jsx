...
export default function VendorDashboard() {
  ...
  return (
    <div className="flex bg-gray-100">
      <aside className="h-screen bg-[#bfb59f] fixed lg:sticky top-0 border-r-2 p-6 pt-10 whitespace-nowrap z-10 closed shadow-xl ">
        ...
        <p className="mb-1 font-extrabold tracking-wide text-white">
          Navigation
        </p>
        ...
        <ul className="text-gray-500 font-semibold flex flex-col gap-2">
          ...
          <li>
            <a
              ...
              className={`flex items-center text-white rounded px-3 py-2 hover:text-white hover:bg-[#d2c2b2] transition-all ${
                activeLink === "Calendar" ? "text-white bg-[#d2c2b2]" : ""
              }`}
            >
          ...
          <li>
            <a
              href="#"
              onClick={logout}
              className="flex items-center text-white rounded px-3 py-2 hover:text-white hover:bg-[ bg-[#d2c2b2]] transition-all"
            >
      ...
      <div className="w-full">
        <header className="px-6 lg:px-8 pb-4 lg:pb-6 pt-6 lg:pt-10 shadow bg-[#bfb59f] mb-1 sticky top-0 flex justify-between items-center">
          <div>
        ...
        <main className="px-6 py-8 lg:px-8 bg-[#eff5f7] flex flex-col gap-6 z-20">
          {content}
        </main>
      </div>
    </div>
